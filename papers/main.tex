...
\begin{document}
	...
	The magnetoelectric effect is however not limited to the static regime, and can also generate a resonant coupling between an electric field and the spin excitations in a magnetic material. This coupling is described by the polarization operator, $\hat{\bm P_{i}}$, which results in the Hamiltonian \cite{moriyaTheoryLightScattering1967,zhuSpinorbitCouplingElectronic2014,malzTopologicalMagnonAmplification2019,seifertOpticalExcitationMagnons2019}
	\begin{equation}
	...
	We note here that the plasmons also generate a magnetic field, which couples to the magnons through the Zeeman coupling \cite{costaStronglyCoupledMagnonplasmon2023,yuanStrongTunableCoupling2024,yuanBreakingSurfacePlasmonExcitation2024}. This process generates a bilinear plasmon-magnon coupling, and can thus be readily distuingished from the quadratic in magnon operators coupling we consider here. 
