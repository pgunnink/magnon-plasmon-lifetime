...
%DIF DEL V1/main.tex   Tue Jan 20 15:38:22 2026
%DIF ADD main.tex      Tue Jan 20 15:38:22 2026
...
\begin{document}
	...
	One of the possible information carriers considered are plasmons, the quanta of \DIFdelbegin \DIFdel{charge density waves }\DIFdelend \DIFaddbegin \DIFadd{charge-carrier density oscillations }\DIFaddend \cite{alonsocalafellQuantumComputingGraphene2019}. 
...
, representing considerable challenges for quantum applications. Here, we tackle the question of coupling plasmons to magnons without spin-orbit coupling and at zero temperature}\DIFdelend \DIFaddbegin \DIFadd{interactions, and at zero temperature. If so, it could potentially exceed the intrinsic decay rate of the quasiparticles, offering a promising avenue for quantum technologies operating at ultralow temperatures. In this work, we provide an affirmative answer}\DIFaddend . We show that plasmons can also couple to the \emph{continuum} formed by antiferromagnetic (AFM) magnons. This coupling is enabled by the electric field of the plasmon that interacts with the microscopic electric polarization of the material and, in turn, with the magnetic order \cite{bolensTheoryElectronicMagnetoelectric2018}. 
	...
	In addition, the coupling remains at zero temperature. We argue that \DIFdelbegin \DIFdel{this coupling can potentially realize a strong coupling between the plasmons and spin-zero two-magnon continuum, opening the }\DIFdelend \DIFaddbegin \DIFadd{it naturally holds the potential for realizing a large coupling rate between magnons and plasmons, sufficient to reach the ultrastrong coupling regime \mbox{%DIFAUXCMD
\cite{friskkockumUltrastrongCouplingLight2019}}\hskip0pt%DIFAUXCMD
, where the coupling exceeds the typical magnon and plasmon decay rate. This development opens the }\DIFaddend way for coherent transfer of quantum information \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
\cite{moriyaTheoryLightScattering1967,seifertOpticalExcitationMagnons2019,bolensTheoryElectronicMagnetoelectric2018}}\hskip0pt%DIFAUXCMD
	...
	We continue by considering the electric field operator $\hat{\bm E}_i$ of a plasmon in the 2DEG, which at position $\bm r_i$ in the \DIFdelbegin \DIFdel{antiferromagnetic film }\DIFdelend \DIFaddbegin \DIFadd{antiferromagnet }\DIFaddend is given by \cite{ferreiraQuantizationGraphenePlasmons2020}
	\begin{equation}
